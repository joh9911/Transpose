...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
     ...
     * with version reference <b>prettytime</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getPrettytime() {
        return create("prettytime");
    }
    ...
    public static class AndroidxMaterial3LibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        private final AndroidxMaterial3ZLibraryAccessors laccForAndroidxMaterial3ZLibraryAccessors = new AndroidxMaterial3ZLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>androidx.material3.z</b>
         */
        public AndroidxMaterial3ZLibraryAccessors getZ() {
            return laccForAndroidxMaterial3ZLibraryAccessors;
        }

    }

    public static class AndroidxMaterial3ZLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public AndroidxMaterial3ZLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>z</b> with <b>androidx.compose.material3:material3-*</b> coordinates and
         * with version reference <b>material3Z</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
            return create("androidx.material3.z");
        }

        /**
         * Dependency provider for <b>v130beta05</b> with <b>androidx.compose.material3:material3-*</b> coordinates and
         * with version reference <b>material3ZVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV130beta05() {
            return create("androidx.material3.z.v130beta05");
        }
    ...
    public static class GoogleApiClientLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>googleApiClientGson</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getGson() {
    ...
    public static class HiltAndroidCompilerLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v248</b> with <b>com.google.dagger:hilt-android-compiler</b> coordinates and
         * with version reference <b>hiltAndroidCompiler</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV248() {
            return create("hilt.android.compiler.v248");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>googleApiClientGson</b> with value <b>2.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGoogleApiClientGson() { return getVersion("googleApiClientGson"); }
        ...
        /**
         * Version alias <b>hiltAndroidVersion</b> with value <b>2.48</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>material3</b> with value <b>1.3.0-beta05</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>material3Z</b> with value <b>1.3.0-beta03</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMaterial3Z() { return getVersion("material3Z"); }

        /**
         * Version alias <b>material3ZVersion</b> with value <b>1.3.0-beta05</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMaterial3ZVersion() { return getVersion("material3ZVersion"); }

        /**
         * Version alias <b>media3Exoplayer</b> with value <b>1.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>newpipeextractor</b> with value <b>0.24.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>prettytime</b> with value <b>5.0.8.Final</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPrettytime() { return getVersion("prettytime"); }
